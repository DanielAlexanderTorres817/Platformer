...
void Title::initialise()
{
    ...
    m_game_state.map = new Map(21, 16, TITLE_DATA, map_texture_id, 0.5f, 7, 6);
...
void Title::render(ShaderProgram* g_shader_program)
{
    ...
    Utility::draw_text(g_shader_program, g_font_texture_id, "(press ENTER please)", 0.3f, 0.0f, glm::vec3(-2.75f, 1.5f, 0.0f));
